...
silent only
silent tabonly
cd /mnt/data/Document/DSP/hw1/dsp_hw1/hw1_b05901105
...
silent! normal! zE
let s:l = 56 - ((15 * winheight(0) + 19) / 39)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 88 - ((11 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
88
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 276 - ((9 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
276
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 117 - ((7 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
117
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 101 - ((39 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
101
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 110 - ((19 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
110
