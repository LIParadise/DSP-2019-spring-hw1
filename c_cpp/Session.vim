...
exe 'vert 2resize ' . ((&columns * 69 + 73) / 146)
exe '3resize ' . ((&lines * 19 + 21) / 42)
exe 'vert 3resize ' . ((&columns * 69 + 73) / 146)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
125
normal! zo
let s:l = 198 - ((24 * winheight(0) + 19) / 39)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 94 - ((12 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
94
...
120
normal! zo
let s:l = 263 - ((3 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
263
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 267 - ((11 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
267
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((13 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 83 - ((2 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 21 - ((2 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
exe '3resize ' . ((&lines * 19 + 21) / 42)
exe 'vert 3resize ' . ((&columns * 86 + 73) / 146)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 85 - ((18 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
85
