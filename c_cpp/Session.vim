...
silent! normal! zE
let s:l = 30 - ((18 * winheight(0) + 9) / 19)
...
119
normal! zo
let s:l = 167 - ((13 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
167
...
exe 'vert 2resize ' . ((&columns * 85 + 79) / 159)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 261 - ((11 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
261
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 29 - ((8 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
