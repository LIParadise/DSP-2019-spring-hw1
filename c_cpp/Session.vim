...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 74 + 73) / 146)
exe 'vert 2resize ' . ((&columns * 71 + 73) / 146)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
125
normal! zo
let s:l = 359 - ((29 * winheight(0) + 19) / 39)
...
120
normal! zo
let s:l = 206 - ((17 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
206
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 94 - ((26 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
94
